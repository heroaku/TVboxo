var rule = {
    ...
    图片预处理: `js:
        ...
        if ($('img[data-src]').length > 0) {
            imgUrl = $('img[data-src]').attr('data-src');
        } else if ($('img[src]').length > 0) {
            imgUrl = $('img[src]').attr('src');
        }
