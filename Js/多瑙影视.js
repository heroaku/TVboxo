var rule = {
    ...
    二级:{"title":"h2&&Text;.content_detail.content_min.fl&&ul&&li:eq(0)&&Text","img":".content_thumb .vodlist_thumb&&data-original","desc":".content_detail.content_min.fl li:eq(0)&&Text;.content_detail.content_min.fl li:eq(3)&&Text;.content_detail.content_min.fl&&ul&&li:eq(2)&&Text","content":".content&&Text","tabs":".play_source_tab:eq(0) a","lists":".content_playlist:eq(#id) li"},
