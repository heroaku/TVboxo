var rule={
		...
		二级:{"title":"h2&&Text;.data:eq(0) a:eq(0)&&Text","img":".lazyload&&data-original","desc":";.data:eq(0) a:eq(2)&&Text;.data:eq(-1) a:eq(2)&&Text;.data:eq(-1) a:eq(1)&&Text;.play-top p:eq(0)&&Text;.play-top p:eq(1)&&Text","content":".play-bottom&&Text","tabs":".swiper-slide.zbs a","lists":".content-playlist:eq(#id) a"},
