var rule={
    ...
    二级:{"title":"h1&&Text;.s-top-info-title&&Text","img":"img&&src","desc":".data:eq(0)&&Text;.data:eq(1)&&Text;.data:eq(2)&&Text;.data:eq(3)&&Text","content":".mo-word-info&&Text","tabs":"h2.mo-fsxs-14px&&.mo-movs-btns","lists":"ul.mo-movs-item:eq(#id)&&li"},
