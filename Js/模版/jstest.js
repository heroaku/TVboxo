var rule = {
    ...
    lazy:'',
    limit:6,
    推荐:'.module-items.module-poster-items-base;a&&title;img&&data-original;.module-item-note&&Text;a&&href',
    double:true, // 推荐内容是否双层定位
    一级:'.module-items.module-poster-items-base a;a&&title;img&&data-original;.module-item-note&&Text;a&&href',
