var rule = {
    ...
    二级:{"title":"h1&&Text;.cr3&&Text","img":".detailpic&&img&&src","desc":".module-info-content&&.module-info-item:eq(-2)&&Text;.detailinfo&&p:eq(-8)&&Text;.detailinfo&&p:eq(7)&&Text;.album-title&&Text;.detailinfo&&p:eq(1)&&Text","content":".tjuqing&&Text","tabs":".yunplay&&.downtitle&&ul li","lists":".videolist:eq(#id) a"},
