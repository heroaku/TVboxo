var rule = { // 模板字典
    ...
    二级:{"title":".myui-content__detail .title&&Text;.t-muted:eq(-1)&&Text","img":".lazyload&&data-original","desc":";;.myui-content__detail p:eq(2)&&Text;.col-pd.text-collapse p:eq(1)&&Text;.col-pd.text-collapse p:eq(0)&&Text","content":".sketch.content&&Text","tabs":".nav-tabs:eq(0) li","lists":".myui-content__list:eq(#id) li"},
