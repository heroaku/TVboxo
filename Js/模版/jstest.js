var rule={
    ...
    二级:{"title":"h1&&Text;.module-info-tag&&Text","img":"img&&data-original","desc":".module-info-item:eq(1)&&Text;.module-info-item:eq(2)&&Text;.module-info-item:eq(3)&&Text","content":".module-info-introduction&&Text","tabs":".module-tab-item.module-item","lists":".module-play-list:eq(#id) a"},
