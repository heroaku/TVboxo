var rule = {
    ...
    二级:{"title":"h1&&Text;.uk-list&&li:eq(3)&&Text","img":".cover-shadow-xs&&data-original","desc":".module-info-content&&.module-info-item:eq(-2)&&Text;.module-info-content&&.module-info-item:eq(-4)&&Text;.module-info-content&&.module-info-item:eq(-3)&&Text;.uk-list&&li:eq(0)&&Text;.uk-list&&li:eq(1)&&Text","content":".uk-list&&li:eq(9)&&Text","tabs":".uk-switcher.uk-margin-small&&li:eq(#id) ul.fed-part-rows:eq(0) li","lists":".uk-switcher.uk-margin-small&&li:eq(#id) ul.fed-part-rows:eq(1) li"},
