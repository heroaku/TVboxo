var rule={
    ...
    二级:{"title":".myui-content__detail .title&&Text;.text-muted:eq(-1)&&Text","img":".lazyload&&src","desc":".text-muted:eq(-1)&&Text;.text-muted:eq(5)&&Text;.myui-content__detail p:eq(6)&&Text;.myui-content__detail p:eq(7)&&Text;.myui-content__detail p:eq(4)&&Text","content":".content&&Text","tabs":".nav-tabs:eq(0) li","lists":".myui-content__list:eq(#id) li"},
